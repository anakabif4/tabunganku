            ...
            <div class="section-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-money-check-alt"></i> TAMBAH HUTANG </h4>
                    </div>

                    <div class="card-body">

                        <form action="{{ route('account.hutang.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>TANGGAL</label>
                                        <input type="text" class="form-control datetimepicker" name="hutang_date" placeholder="Pilih Tanggal">
