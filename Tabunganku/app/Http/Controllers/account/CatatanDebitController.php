...
class CatatanDebitController extends Controller
{
    /**
     * CatatanDebitController constructor.
     */
    ...
    {
        return view('account.catatan_debit.index');
    }
    ...
    public function check(Request $request)
    {
        ...
        return view('account.catatan_debit.index', compact('debit', 'tanggal_awal', 'tanggal_akhir'));
    }
