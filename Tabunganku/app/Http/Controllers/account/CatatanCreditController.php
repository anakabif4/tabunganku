...
class CatatanCreditController extends Controller
{
    /**
     * CatatanCreditController constructor.
     */
    ...
    {
        return view('account.catatan_credit.index');
    }
    ...
    public function check(Request $request)
    {
        ...
        return view('account.catatan_credit.index', compact('credit', 'tanggal_awal', 'tanggal_akhir'));
    }
}
